...
class AudioAsset extends AssetPlugin {

	// define plugin parameters
	protected $PLUGINID			= 'audio-asset';
	protected $PLUGINSHORTNAME	= 'Audio';
	protected $PLUGINNAME		= 'CME/X Audio Asset Plugin';
	protected $PLUGINCOMMENT	= 'With this plugin, you are able to create Audio assets in accordance with the CME/X Specification.';
	protected $PLUGINVIEW		= 'AudioAsset-View.php';

	// collection definition
	protected $COLLECTION		= 'audioCollection';
	protected $COLLECTIONTYPE	= 'AudioCollection';
	...
	function asXML() {
		...
		$xml .= '<Audio dc:title="'.$title.'" cmx:isrc="'.$isrc.'" cmx:genre="'.$genre.'" rdf:parseType="Resource">';
		$xml .= '<displayArtist rdf:resource="contributors/'.$artist.'" />';
